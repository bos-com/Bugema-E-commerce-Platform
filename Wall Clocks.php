...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart'])) {
    ...
    header("Location: Wall Clocks.php");
    exit();
}
...
<head>
    ...
    <title>Bugema CampusShop - Clocks</title>
        ...
        <div class="container">
            ...
            <nav>
                <ul class="nav-links">
                    ...
                    <li><a href="Wall Clocks.php" class="active">Clocks</a></li>
            ...
            <div class="mobile-menu">
                ...
                <div class="mobile-nav">
                    ...
                    <a href="Wall Clocks.php" class="active">Clocks</a>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <div class="product-card">
                            ...
                            <form method="POST" action="Wall Clocks.php">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const responses = {
                ...
                'products': 'We offer Bags, branded jumpers, pens, wall clocks, notebooks, T-shirts, and bottles. Browse categories via the "Browse Categories" button!',
